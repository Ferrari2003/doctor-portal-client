        ...
        <div className='w-96 p-7'>
            ...
            <form onSubmit={handleSubmit(handleDoctors)}>
                ...
                <div className="form-control w-full max-w-xs">
                    ...
                    <input type="file"
                        {...register('image', { required: "Photo is required" })} className="input input-bordered w-full max-w-xs" />
                        {errors.img?.type === 'required' && <p className='text-red-600'>Photo is required</p>}
                </div>
                <br />
